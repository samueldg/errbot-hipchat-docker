...
# Setting defaults
env.setdefault('BOT_ADMINS', 'admin@localhost')
env.setdefault('BOT_LOG_LEVEL', 'INFO')
env.setdefault('BOT_PREFIX', '!')
...
BOT_LOG_LEVEL = logging.getLevelName(env.get('BOT_LOG_LEVEL'))
...
BOT_ADMINS = tuple(env.get('BOT_ADMINS').split(','))
...
CHATROOM_PRESENCE = tuple(env.get('CHATROOM_PRESENCE').split(','))
...
# CHATROOM_FN = 'Err'
CHATROOM_FN = env.get('CHATROOM_FN')
